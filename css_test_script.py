...
try:
	...
	pass
class css_test_script(ControlSurface):
	def __init__(self, c_instance):
		super(css_test_script, self).__init__(c_instance)
	...
	def _inputs(self):
		...
		self.midi_note_ch_0_val_26.pre_val = 0
		self.midi_note_ch_0_val_26.cur_val = 0
		...
		self.midi_note_ch_0_val_27.pre_val = 0
		self.midi_note_ch_0_val_27.cur_val = 0
		...
		self.midi_note_ch_0_val_64 = ConfigurableButtonElement(True, MIDI_NOTE_TYPE, 0, 64)
		...
		self.midi_note_ch_0_val_64.pre_val = 0
		self.midi_note_ch_0_val_64.cur_val = 0
		self.midi_note_ch_0_val_65 = ConfigurableButtonElement(True, MIDI_NOTE_TYPE, 0, 65)
		...
		self.midi_note_ch_0_val_65.pre_val = 0
		self.midi_note_ch_0_val_65.cur_val = 0
		...
		self.midi_note_ch_0_val_24 = EncoderElement(MIDI_NOTE_TYPE, 0, 24, _map_modes.absolute)
		self.midi_note_ch_0_val_24.add_value_listener(self.placehold_listener,identify_sender= False)
		self.midi_note_ch_0_val_24.pre_val = 0
		self.midi_note_ch_0_val_24.cur_val = 0
	...
	def device_parameter_banks(self):
		self.device_id_3_banks = ["parameter_bank_1_id_4"]
	...
	def _mode1_configs(self):
		self.mode_1_configs_map = [
			...
			"parameter_bank_1_id_4",
			"parameter_1_id_5"]
		self.track_selector_1_id_2 = {}
		self.track_selector_1_id_2["track"] = self.track_num(2)
		self.track_selector_1_id_2["module"] = "self.song().tracks[self.track_num(2)]"
		...
		self.track_selector_1_id_2["parent_name"] = "mode_1_id_1"
		self.device_selector_1_id_3 = {}
		self.device_selector_1_id_3["track"] = self.track_num(2)
		self.device_selector_1_id_3["module"] = "self.song().tracks[self.track_num(2)].devices[0]"
		...
		self.parameter_bank_1_id_4 = {}
		self.parameter_bank_1_id_4["LED_mapping_type_needs_feedback"] = ""
		self.parameter_bank_1_id_4["LED_feedback"] = "custom"
		self.parameter_bank_1_id_4["LED_feedback_active"] = ""
		self.parameter_bank_1_id_4["LED_on"] = "127"
		self.parameter_bank_1_id_4["LED_off"] = "0"
		self.parameter_bank_1_id_4["LED_send_feedback_to_selected"] = []
		self.parameter_bank_1_id_4["json_id"] = 4
		self.parameter_bank_1_id_4["mapping_name"] = "Parameter Bank 1"
		self.parameter_bank_1_id_4["mapping_type"] = "Parameter Bank"
		self.parameter_bank_1_id_4["parent_json_id"] = 3
		self.parameter_bank_1_id_4["parent_name"] = "device_selector_1_id_3"
		self.parameter_1_id_5 = {}
		self.parameter_1_id_5["attached_to"] = "midi_note_ch_0_val_24"
		self.parameter_1_id_5["track"] = self.track_num(2)
		self.parameter_1_id_5["module"] = "self.song().tracks[self.track_num(2)].devices[0].parameters[1]"
		self.parameter_1_id_5["element"] = "value"
		self.parameter_1_id_5["output_type"] = "val"
		self.parameter_1_id_5["minimum"] = round(0,2)
		self.parameter_1_id_5["maximum"] = round(100,2)
		self.parameter_1_id_5["decimal_places"] = 2
		self.parameter_1_id_5["ui_listener"] = "value"
		self.parameter_1_id_5["feedback_brain"] = "feedback_range"
		self.parameter_1_id_5["ctrl_type"] = "absolute"
		self.parameter_1_id_5["enc_first"] = 0
		self.parameter_1_id_5["enc_second"] = 127
		self.parameter_1_id_5["reverse_mode"] = False
		self.parameter_1_id_5["takeover_mode"] = "None"
		self.parameter_1_id_5["steps"] = 50
		self.parameter_1_id_5["LED_mapping_type_needs_feedback"] = "1"
		self.parameter_1_id_5["LED_feedback"] = "default"
		self.parameter_1_id_5["LED_feedback_active"] = "1"
		...
		self.parameter_1_id_5["parent_json_id"] = 4
		self.parameter_1_id_5["parent_name"] = "parameter_bank_1_id_4"
	...
	def _mode1_ui_listeners(self):
		if self.device_id_3_active_bank == 0:
			try:
				self.parameter_1_id_5_led = eval(self.parameter_1_id_5["module"])
				self.parameter_1_id_5_led.add_value_listener(self.parameter_1_id_5_led_listener)
			except:
				self.log("_mode1_ui_listeners: " + str(self.parameter_1_id_5["element"]) + " does not exist")
	def _remove_mode1_ui_listeners(self):
		try:
			self.parameter_1_id_5_led.remove_value_listener(self.parameter_1_id_5_led_listener)
		except:
			self.log("remove__mode1_ui_listeners: " + str(self.parameter_1_id_5["element"]) + " does not exist")
	def _mode1_fire_all_feedback(self):
		if self.device_id_3_active_bank == 0:
			self.parameter_1_id_5_led_listener()
	def parameter_1_id_5_led_listener(self):
		self.feedback_brain(self.parameter_1_id_5)	
	################## CORE: Python 3 #################
	...
	def disconnect(self):
		...
		super(css_test_script, self).disconnect()